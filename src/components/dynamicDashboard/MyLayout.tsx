         ...
         <div className="relative flex justify-between items-center bg-secondary h-[28px]">
            ...
            <div className="flex items-center justify-end space-x-5 h-[100%] bg-explain w-56 pr-3 rounded-t ">
               <div className="list-widgets-container" data-headlessui-state>
                  ...
                  style={{ display: this.state.showDropMenu ? 'none' : 'block'}}
                  >
                  <div
                ...
                <div className="scrollbar-thin scrollbar-thumb-rounded-full scrollbar-thumb-scroll list-widget">
                        ...
                        <div className="text-color-disabled px-3 py-1" id="headlessui-menu-item-179" role="menuitem" tabIndex={-1} data-headlessui-state>
                           <div className="flex w-full justify-between items-center">
                              <div className="flex items-center space-x-1"><button 
                               ...
                               onMouseDown={(event) => this.onAddDragMouseDown(event, "tableprice")}
                               onTouchStart={(event) => this.onAddDragMouseDown(event, "tableprice")}
                              >Bảng giá</button></div>
                  ...
                  <div role="none">
                     <div className="bg-invert text-color-tertiary font-medium px-3 py-1.5 mb-1" role="none">Giao dịch</div>
                     <div className="space-y" role="none">
                        <div className="text-color-disabled px-3 py-1" id="headlessui-menu-item-179" role="menuitem" tabIndex={-1} data-headlessui-state>
                           <div className="flex w-full justify-between items-center">
                              <div className="flex items-center space-x-1"><span 
                                      //  disabled={this.state.adding}
                               onMouseDown={(event) => this.onAddDragMouseDown(event, "orderform")}
                               onTouchStart={(event) => this.onAddDragMouseDown(event, "orderform")}
                              >Đặt lệnh</span></div>
                              <span className="bg-sell w-3 h-3 rounded-full" />
                           </div>
                        </div>
                        <div className="text-color-disabled px-3 py-1" id="headlessui-menu-item-180" role="menuitem" tabIndex={-1} data-headlessui-state>
                           <div className="flex w-full justify-between items-center">
                              <div className="flex items-center space-x-1"><span >Lệnh chờ khớp</span></div>
                              <span className="bg-sell w-3 h-3 rounded-full" />
                           </div>
                        </div>
                        <div className="hover:bg-invert hover:text-color-highlight cursor-pointer px-3 py-1" id="headlessui-menu-item-181" role="menuitem" tabIndex={-1} data-headlessui-state>
                  ...
                  <div role="none">
                     <div className="bg-invert text-color-tertiary font-medium px-3 py-1.5 mb-1" role="none">Tài sản</div>
                     <div className="space-y" role="none">
                        <div className="text-color-disabled px-3 py-1" id="headlessui-menu-item-179" role="menuitem" tabIndex={-1} data-headlessui-state>
                           <div className="flex w-full justify-between items-center">
                              <div className="flex items-center space-x-1"><span 
                                      //  disabled={this.state.adding}
                               onMouseDown={(event) => this.onAddDragMouseDown(event, "totalmonney")}
                               onTouchStart={(event) => this.onAddDragMouseDown(event, "totalmonney")}
                              >Số dư tiền</span></div>
                              <span className="bg-sell w-3 h-3 rounded-full" />
                           </div>
                        </div>
