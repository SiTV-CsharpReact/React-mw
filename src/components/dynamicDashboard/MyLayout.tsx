...
class MyLayout extends React.Component<any, { layoutFile: string | null, model: Model | null, json?: string, adding: boolean, fontSize: string, realtimeResize: boolean }> {
    ...
    super(props);
    this.state = { layoutFile: null, model: Model.fromJson(json), adding: false, fontSize: "medium", realtimeResize: false };
